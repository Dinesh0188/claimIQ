...
| retrieval | BM25 + `fastembed` dense, fused with RRF | No vector database. 41 chunks. An in-process NumPy dot product is the correct data structure at this size; a Qdrant container would be infrastructure to make a demo look bigger. |
